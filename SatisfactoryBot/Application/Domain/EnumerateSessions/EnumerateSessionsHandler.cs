...
internal class EnumerateSessionsHandler : IRequestHandler<EnumerateSessionsQuery, BaseResponse<EnumerateSessionsResponse>>
{
    ...
    public async Task<BaseResponse<EnumerateSessionsResponse>> Handle(EnumerateSessionsQuery request, CancellationToken cancellationToken)
    {
        try
        {
